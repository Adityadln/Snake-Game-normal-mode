...
let foodCheck=1;
let gameNO=0;
let words=['delta','games','snake','bonus','tails','heads',
'stars','point','image','white']; 
let speedInc=1;
...
let wordOrder=document.querySelector('.wordSeq');
...
function startgame(){ 
    ...
    food1.innerHTML=words[randomValue][0];
    food2.innerHTML=words[randomValue][1];
    food3.innerHTML=words[randomValue][2];
    food4.innerHTML=words[randomValue][3];
    food5.innerHTML=words[randomValue][4];

    wordOrder.innerHTML=words[randomValue];

    food1.style.opacity='1';
    food2.style.opacity='1';
    food3.style.opacity='1';
    food4.style.opacity='1';
    food5.style.opacity='1';
...
food5:{x:Math.floor(Math.random()*30)*20 ,y:Math.floor(Math.random()*30)*20 }
   ...
   food4.style.left=coordinates.food4.x +'px';
    ...
    food5.style.left=coordinates.food5.x +'px';
    food5.style.top=coordinates.food5.y +'px';
...
/*defines in which order the snake has to eat*/
    ...
    coordinates.head.y===coordinates.food1.y && foodCheck%5 ===1 ){
    ...
    coordinates.head.y===coordinates.food2.y &&foodCheck%5 ===2){
        ...
        coordinates.head.y===coordinates.food3.y && foodCheck%5 ===3){
        ...
        coordinates.head.y===coordinates.food4.y && foodCheck%5 ===4){
        ...
        else if(coordinates.head.x===coordinates.food5.x && 
            coordinates.head.y===coordinates.food5.y && foodCheck%5 ===0){
                
                food5.style.opacity='0';
                points++;
                foodCheck++;
                time+=4;
                point.innerHTML=`${points}`;
